...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    Button$(Position, ButtonName, Action, OnColor, OffColor) {
      var t1 = new A.Button(new A.Vector2());
      t1.Position = Position;
      t1.Button$5(Position, ButtonName, Action, OnColor, OffColor);
      return t1;
    },
    Button: function Button(t0) {
      var _ = this;
      _.ButtonObject = null;
      _.OffColor = _.OnColor = "";
      _.State = false;
      _.Action = null;
      _.Position = t0;
      _.isActive = true;
    },
    Button_closure: function Button_closure(t0) {
      this.$this = t0;
    },
    ...
    Game_Initialize_closure: function Game_Initialize_closure() {
    },
    Game_Initialize_closure0: function Game_Initialize_closure0() {
    },
    Game_Initialize_closure1: function Game_Initialize_closure1(t0) {
      this.$this = t0;
    },
    Game_Tick_closure: function Game_Tick_closure() {
    },
    Game_Tick_closure0: function Game_Tick_closure0() {
    },
    GameEvent: function GameEvent(t0) {
      this.Subscribers = t0;
    },
    GameEvent_Fire_closure: function GameEvent_Fire_closure() {
    },
    Level: function Level(t0, t1) {
      var _ = this;
      _.Imports = t0;
      _.LevelActions = t1;
      _.OnActionAdd = _.JsonPreview = null;
    },
    ListGroup: function ListGroup() {
    },
    TimeLine: function TimeLine(t0, t1) {
      var _ = this;
      _.TimeLineScrollBar = t0;
      _.Container = null;
      _.Position = t1;
      _.isActive = true;
    },
    TimeLine_Init_closure: function TimeLine_Init_closure(t0) {
      this.$this = t0;
    },
    TimeLine_RenderTimeline_closure: function TimeLine_RenderTimeline_closure(t0) {
      this.$this = t0;
    },
    TimeLine_RenderTimeline__closure: function TimeLine_RenderTimeline__closure(t0, t1) {
      this.$this = t0;
      this.key = t1;
    },
    UIComponent: function UIComponent() {
    },
    UIGrid: function UIGrid(t0, t1) {
      var _ = this;
      _.gridy = _.gridx = 0;
      _._gridSlider = t0;
      _.Position = t1;
    ...
    UIIdle: function UIIdle() {
    },
    UIManager: function UIManager(t0, t1) {
      this.States = t0;
      this.CurrentState = null;
      this.Components = t1;
    },
    UIManager_Init_closure: function UIManager_Init_closure(t0) {
      this.$this = t0;
    },
    UIManager_Init_closure0: function UIManager_Init_closure0() {
    },
    UIManager_Tick_closure: function UIManager_Tick_closure() {
    },
    UIManager_Draw_closure: function UIManager_Draw_closure() {
    },
    UIState: function UIState() {
    },
    Vector2$(x, y) {
      var t1 = new A.Vector2();
      t1.x = x;
      t1.y = y;
      return t1;
    },
    ...
    main(args) {
      var t1, t2, t3;
      A.print("Hello World!");
      t1 = new A.Level(A._setArrayType([], type$.JSArray_String), new A.JsLinkedHashMap(type$.JsLinkedHashMap_String_dynamic));
      t2 = document;
      t1.JsonPreview = t2.querySelector("#JsonPreview");
      $.$get$Stopwatch__frequency();
      t1 = new A.Game(t1, new A.Stopwatch());
      t2 = type$.CanvasElement._as(t2.querySelector("#canvas"));
      $.Game_CANVAS = t2;
      t2 = t2.getContext("2d");
      $.Game_CTX = t2;
      t2 = $.Game_CANVAS;
      t3 = t2 == null;
      $.Game_WIDTH = t3 ? null : t2.width;
      $.Game_HEIGHT = t3 ? null : t2.height;
      $.MainGame = t1;
      t1.Initialize$0();
    }
  },
  ...
  A.Button.prototype = {
    Button$5(Position, ButtonName, Action, OnColor, OffColor) {
      var _this = this,
        t1 = type$.nullable_ButtonElement._as(document.querySelector(ButtonName));
      _this.ButtonObject = t1;
      _this.Action = Action;
      _this.OnColor = OnColor;
      _this.OffColor = OffColor;
      if (t1 != null)
        B.ButtonElement_methods.addEventListener$2(t1, "click", new A.Button_closure(_this));
    }
  };
  A.Button_closure.prototype = {
    call$1($event) {
      var t1, t2, t3;
  ...
  A.Game.prototype = {
    Initialize$0() {
      var t2, t3, t4, t5, t6, json,
        t1 = this.level;
      A.print("Initialize Level");
      t2 = new A.GameEvent(A._setArrayType([], type$.JSArray_Function));
      t1.OnActionAdd = t2;
      A.print(t2.toString$0(0));
      t2 = new A.UIManager(A._setArrayType([], type$.JSArray_UIState), A._setArrayType([], type$.JSArray_UIComponent));
      t2.Init$0();
      this.GUI = t2;
      t2 = document.querySelector("#console");
      if (t2 == null)
        t2 = type$.Element._as(t2);
      $.Console__CONSOLE = t2;
      J.set$innerHtml$x(t2, "Console has been initialized");
      t2 = t1.LevelActions;
      t3 = type$.String;
      t4 = type$.JSArray_Map_String_String;
      t5 = type$.List_Map_String_String;
      t6 = type$.dynamic;
      t2.addAll$1(0, A.LinkedHashMap_LinkedHashMap$_literal(["1", A.LinkedHashMap_LinkedHashMap$_literal(["Actions", A._setArrayType([A.LinkedHashMap_LinkedHashMap$_literal(["ActionType", "PlayerSpawn"], t3, t3), A.LinkedHashMap_LinkedHashMap$_literal(["ActionType", "EnemySpawn"], t3, t3)], t4)], t3, t5), "2", A.LinkedHashMap_LinkedHashMap$_literal(["Actions", A._setArrayType([A.LinkedHashMap_LinkedHashMap$_literal(["ActionType", "PlayerSpawn"], t3, t3), A.LinkedHashMap_LinkedHashMap$_literal(["ActionType", "EnemySpawn2"], t3, t3)], t4)], t3, t5), "3", A.LinkedHashMap_LinkedHashMap$_literal(["Actions", A._setArrayType([A.LinkedHashMap_LinkedHashMap$_literal(["ActionType", "PlayerSpawn"], t3, t3), A.LinkedHashMap_LinkedHashMap$_literal(["ActionType", "EnemySpawn3"], t3, t3)], t4)], t3, t5), "4", A.LinkedHashMap_LinkedHashMap$_literal(["Actions", A._setArrayType([A.LinkedHashMap_LinkedHashMap$_literal(["ActionType", "PlayerSpawn"], t3, t3), A.LinkedHashMap_LinkedHashMap$_literal(["ActionType", "EnemySpawn4"], t3, t3)], t4)], t3, t5), "60", A.LinkedHashMap_LinkedHashMap$_literal(["Actions", A._setArrayType([A.LinkedHashMap_LinkedHashMap$_literal(["ActionType", "PlayerSpawn"], t3, t3), A.LinkedHashMap_LinkedHashMap$_literal(["ActionType", "EnemySpawn5"], t3, t3)], t4)], t3, t5)], t3, t6));
      t2.addAll$1(0, A.LinkedHashMap_LinkedHashMap$_literal(["100", A.LinkedHashMap_LinkedHashMap$_literal(["Actions", A._setArrayType([A.LinkedHashMap_LinkedHashMap$_literal(["ActionType", "PlayerSpawn"], t3, t3), A.LinkedHashMap_LinkedHashMap$_literal(["ActionType", "EnemySpawn6"], t3, t3)], t4)], t3, t5)], t3, t6));
      t6 = t1.OnActionAdd;
      if (t6 != null)
        t6.Fire$0();
      json = B.C_JsonCodec.encode$2$toEncodable(t2, null);
      t1 = t1.JsonPreview;
      if (t1 != null)
        J.set$innerHtml$x(t1, json);
      t1 = $.Game_CANVAS;
      if (t1 != null) {
        t2 = type$._ElementEventStreamImpl_MouseEvent;
        t3 = t2._eval$1("~(1)?")._as(new A.Game_Initialize_closure());
        type$.nullable_void_Function._as(null);
        A._EventStreamSubscription$(t1, "mousemove", t3, false, t2._precomputed1);
      }
      B.JSArray_methods.forEach$1($.Game_Objects, new A.Game_Initialize_closure0());
      A.Timer_Timer$periodic(new A.Duration(10000), new A.Game_Initialize_closure1(this));
    },
    Tick$0() {
      ...
      ++_this._elapsedTicks;
      B.JSArray_methods.forEach$1($.Game_Objects, new A.Game_Tick_closure());
      t2 = _this.GUI;
      if (t2 != null)
        t2.Tick$0();
      t2 = $.Game_CTX;
      if (t2 != null) {
        ...
        t4 = $.Game_HEIGHT;
        t4.toString;
        t2.clearRect(0, 0, t3, t4);
      }
      B.JSArray_methods.forEach$1($.Game_Objects, new A.Game_Tick_closure0());
      t2 = _this.GUI;
      if (t2 != null)
        t2.Draw$0();
      if (t1.get$elapsedMilliseconds() >= 1000) {
        t2 = B.JSInt_methods.toString$0(_this._elapsedTicks);
        t3 = $.Console__CONSOLE;
        if (t3 != null)
          J.set$innerHtml$x(t3, "Ticks per second: " + t2);
        _this._elapsedTicks = 0;
        t2 = t1._stop;
        t1._start = t2 == null ? $.Primitives_timerTicks.call$0() : t2;
      }
    }
  };
  A.Game_Initialize_closure.prototype = {
    call$1($event) {
      var t1, rect, t2, t3, t4;
      type$.MouseEvent._as($event);
      t1 = $.Game_CANVAS;
      rect = t1 == null ? null : t1.getBoundingClientRect();
      t1 = $event.clientX;
      t2 = $event.clientY;
      t3 = $.$get$Input__MousePosition();
      t4 = rect.left;
      t4.toString;
      t3.x = t1 - t4;
      t4 = rect.top;
  ...
  A.Game_Initialize_closure0.prototype = {
    call$1(object) {
      type$.GameObject._as(object).Init$0();
    },
    $signature: 2
  };
  A.Game_Initialize_closure1.prototype = {
    call$1(timer) {
  ...
  A.Game_Tick_closure.prototype = {
    call$1(object) {
      type$.GameObject._as(object).Tick$0();
    },
    $signature: 2
  };
  A.Game_Tick_closure0.prototype = {
    call$1(object) {
      type$.GameObject._as(object).get$Graph().Draw$0();
    },
    $signature: 2
  };
  A.GameEvent.prototype = {
    Fire$0() {
      B.JSArray_methods.forEach$1(this.Subscribers, new A.GameEvent_Fire_closure());
    }
  };
  A.GameEvent_Fire_closure.prototype = {
    call$1(element) {
      type$.Function._as(element).call$0();
    },
    $signature: 23
  };
  A.Level.prototype = {};
  A.ListGroup.prototype = {};
  A.TimeLine.prototype = {
    Render$0() {
    },
    Init$0() {
      var t2,
        t1 = $.MainGame;
      if (t1 != null) {
        t1 = t1.level.OnActionAdd;
        if (t1 != null) {
          t2 = new A.TimeLine_Init_closure(this);
          A.print("Adding function: " + t2.toString$0(0));
          B.JSArray_methods.add$1(t1.Subscribers, t2);
        }
      }
    },
    Tick$0() {
    ...
    RenderTimeline$0() {
      var t1 = $.MainGame;
      if (t1 != null)
        t1.level.LevelActions.forEach$1(0, new A.TimeLine_RenderTimeline_closure(this));
    }
  };
  A.TimeLine_Init_closure.prototype = {
    call$0() {
      this.$this.RenderTimeline$0();
    },
    $signature: 1
  };
  A.TimeLine_RenderTimeline_closure.prototype = {
    call$2(key, value) {
      var t1, element, inner;
      A._asString(key);
      t1 = document;
      ...
      element.classList.add("lh-sm");
      inner = t1.createElement("span");
      B.SpanElement_methods.insertAdjacentHtml$4$treeSanitizer$validator(inner, "beforeend", key, null, null);
      element.appendChild(inner);
      t1 = this.$this;
      B.DivElement_methods.addEventListener$2(element, "click", new A.TimeLine_RenderTimeline__closure(t1, key));
      J.$index$asx(value, "Actions");
      t1 = t1.Container;
      if (t1 != null)
  ...
  A.TimeLine_RenderTimeline__closure.prototype = {
    call$1($event) {
      type$.Event._as($event);
      B.InputElement_methods.set$value(this.$this.TimeLineScrollBar, this.key);
      return null;
    },
    $signature: 8
  };
  A.UIComponent.prototype = {
    Render$0() {
    },
    Tick$0() {
    },
  ...
  A.UIGrid.prototype = {
    Render$0() {
      var intervalx, intervaly, t2, t3, x, y, t4, t5, t6, _this = this,
        t1 = $.Game_WIDTH;
      t1.toString;
      intervalx = t1 / _this.gridx;
      t1 = $.Game_HEIGHT;
      t1.toString;
      intervaly = t1 / _this.gridy;
      t1 = $.Game_CTX;
      if (t1 != null)
        B.CanvasRenderingContext2D_methods.set$fillStyle(t1, "#333");
      t1 = $.Game_CTX;
      if (t1 != null) {
        t2 = $.Game_WIDTH;
        t2.toString;
      ...
      if (_this.isActive) {
        t1 = $.Game_CTX;
        if (t1 != null)
          B.CanvasRenderingContext2D_methods.set$strokeStyle(t1, "#ccc");
        t1 = $.Game_CTX;
        if (t1 != null)
          t1.lineWidth = 0.5;
        for (x = 0; x < _this.gridx; ++x) {
          t1 = $.Game_CTX;
          if (t1 != null)
            t1.beginPath();
          t1 = $.Game_CTX;
          if (t1 != null)
            t1.moveTo(x * intervalx, 0);
          t1 = $.Game_CTX;
          if (t1 != null) {
            t2 = $.Game_HEIGHT;
            t2.toString;
            t1.lineTo(x * intervalx, t2);
          }
          t1 = $.Game_CTX;
          if (t1 != null)
            t1.stroke();
        ...
        for (y = 0; y < _this.gridy; ++y) {
          t1 = $.Game_CTX;
          if (t1 != null)
            t1.beginPath();
          t1 = $.Game_CTX;
          if (t1 != null)
            t1.moveTo(0, y * intervaly);
          t1 = $.Game_CTX;
          if (t1 != null) {
            t2 = $.Game_WIDTH;
            t2.toString;
            t1.lineTo(t2, y * intervaly);
          }
          t1 = $.Game_CTX;
          if (t1 != null)
            t1.stroke();
      ...
      t1 = $.Game_CTX;
      if (t1 != null)
        B.CanvasRenderingContext2D_methods.set$fillStyle(t1, "#ddd");
      t1 = $.Game_CTX;
      if (t1 != null)
        t1.font = "12px Arial";
      t1 = $.Game_CTX;
      ...
      if (t1) {
        if (t2 != null) {
          t1 = $.$get$Input__MousePosition();
          t3 = t1.x;
          t4 = $.Game_WIDTH;
          t4.toString;
          t5 = t4 / _this.gridx;
          t3 = B.JSNumber_methods.round$0(t3 / t5);
          t1 = t1.y;
          t6 = _this.gridy;
          t4 = B.JSNumber_methods.round$0(t1 / (t4 / t6));
          t1 = $.Game_HEIGHT;
          t1.toString;
          t2.arc(t3 * t5, t4 * (t1 / t6), 5, 0, 6.283185307179586, false);
        }
      } else if (t2 != null) {
        t1 = $.$get$Input__MousePosition();
        t2.arc(t1.x, t1.y, 5, 0, 6.283185307179586, false);
      }
      t1 = $.Game_CTX;
      if (t1 != null)
        t1.stroke();
    ...
    Tick$0() {
      var t1 = this._gridSlider,
        t2 = t1.value;
      t2 = A.Primitives_parseInt(t2 == null ? A._asString(t2) : t2, null);
      this.gridx = t2 == null ? 0 : t2;
      t1 = t1.value;
      t1 = A.Primitives_parseInt(t1 == null ? A._asString(t1) : t1, null);
      this.gridy = t1 == null ? 0 : t1;
    }
  };
  A.UIIdle.prototype = {};
  A.UIManager.prototype = {
    Init$0() {
      var t2, t3, t4, _this = this,
        t1 = _this.States;
      B.JSArray_methods.add$1(t1, new A.UIIdle());
      if (0 >= t1.length)
        return A.ioore(t1, 0);
      t1 = t1[0];
      _this.CurrentState = t1;
      t1 = _this.Components;
      t2 = document;
      t3 = type$.RangeInputElement;
      t4 = new A.UIGrid(t3._as(t2.querySelector("#GridSizeSlider")), new A.Vector2());
      t4.Position = new A.Vector2();
      B.JSArray_methods.add$1(t1, t4);
      t4 = t2.querySelector("#TimeLine");
      t4.toString;
      t2 = new A.TimeLine(t3._as(t2.querySelector("#TimelineScrollBar")), new A.Vector2());
      t2.Position = new A.Vector2();
      t2.Position = new A.Vector2();
      t2.Container = t4;
      B.JSArray_methods.add$1(t1, t2);
      B.JSArray_methods.add$1(t1, A.Button$(new A.Vector2(), "#ToggleGrid", new A.UIManager_Init_closure(_this), "#AAAAAA", "#99CC99"));
      B.JSArray_methods.forEach$1(t1, new A.UIManager_Init_closure0());
    },
    Tick$0() {
      B.JSArray_methods.forEach$1(this.Components, new A.UIManager_Tick_closure());
    },
    Draw$0() {
      B.JSArray_methods.forEach$1(this.Components, new A.UIManager_Draw_closure());
    }
  };
  A.UIManager_Init_closure.prototype = {
    call$0() {
      var t1 = this.$this.Components;
      if (0 >= t1.length)
        return A.ioore(t1, 0);
      t1 = t1[0];
  ...
  A.UIManager_Init_closure0.prototype = {
    call$1(uiobject) {
      type$.UIComponent._as(uiobject).Init$0();
    },
    $signature: 3
  };
  A.UIManager_Tick_closure.prototype = {
    call$1(element) {
      type$.UIComponent._as(element).Tick$0();
    },
    $signature: 3
  };
  A.UIManager_Draw_closure.prototype = {
    call$1(element) {
      type$.UIComponent._as(element).Render$0();
    },
    $signature: 3
  };
  A.UIState.prototype = {};
  ...
  (function installTearOffs() {
    ...
    _static_0(A, "_js_helper_Primitives_dateNow$closure", "Primitives_dateNow", 5);
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.SentinelValue, A.Iterable, A.ListIterator, A.Iterator, A.Closure, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A._StackTrace, A.MapMixin, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A.AsyncError, A._FutureListener, A._Future, A._AsyncCallbackEntry, A.Stream, A.StreamSubscription, A.StreamTransformerBase, A._Zone, A.__SetBase_Object_SetMixin, A._LinkedHashSetCell, A._LinkedHashSetIterator, A._ListBase_Object_ListMixin, A.ListMixin, A.SetMixin, A.Codec, A._JsonStringifier, A.Duration, A.OutOfMemoryError, A.StackOverflowError, A._Exception, A.Null, A._StringStackTrace, A.Stopwatch, A.StringBuffer, A.CssStyleDeclarationBase, A.EventStreamProvider, A._Html5NodeValidator, A.ImmutableListMixin, A.NodeValidatorBuilder, A._SimpleNodeValidator, A._SvgNodeValidator, A.FixedSizeListIterator, A._SameOriginUriPolicy, A._ValidatingTreeSanitizer, A.UIComponent, A.Game, A.GameEvent, A.Level, A.UIState, A.UIManager, A.Vector2]);
    _inheritMany(J.Interceptor, [J.JSBool, J.JSNull, J.JavaScriptObject, J.JSArray, J.JSNumber, J.JSString]);
    _inheritMany(J.JavaScriptObject, [J.LegacyJavaScriptObject, A.EventTarget, A.CanvasRenderingContext2D, A._CssStyleDeclaration_JavaScriptObject_CssStyleDeclarationBase, A.DomException, A.DomImplementation, A.DomRectReadOnly, A.DomTokenList, A.Event, A.Location, A._NodeList_JavaScriptObject_ListMixin, A.__NamedNodeMap_JavaScriptObject_ListMixin]);
    ...
    _inheritMany(A.HtmlElement, [A.AnchorElement, A.AreaElement, A.BaseElement, A.BodyElement, A.ButtonElement, A.CanvasElement, A.DivElement, A.FormElement, A.InputElement, A.SelectElement, A.SpanElement, A.TableElement, A.TableRowElement, A.TableSectionElement, A.TemplateElement]);
    ...
    _inheritMany(A.UIComponent, [A.Button, A.ListGroup, A.UIGrid]);
    _inherit(A.TimeLine, A.ListGroup);
    _inherit(A.UIIdle, A.UIState);
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      GameObject: findType("GameObject"),
      ...
      JSArray_UIComponent: findType("JSArray<UIComponent>"),
      JSArray_UIState: findType("JSArray<UIState>"),
      ...
      UIComponent: findType("UIComponent"),
...
;
  ...
  (function staticFields() {
    ...
    $.Console__CONSOLE = null;
    $.Game_CANVAS = null;
    $.Game_CTX = null;
    $.Game_TICK = 0;
    $.Game_WIDTH = 0;
    $.Game_HEIGHT = 0;
    $.Game_Objects = A._setArrayType([], A.findType("JSArray<GameObject>"));
    $.MainGame = null;
  })();
  (function lazyInitializers() {
    ...
    _lazy($, "Input__MousePosition", "$get$Input__MousePosition", () => A.Vector2$(0, 0));
  })();
